...
{
    public static string HighestForLoop(List<int> nums)
    {
    ...
    public static string HighestForeachLoop(List<int> nums)
    {
        int highestNum = nums[0];
    ...
    public static string HighestWhileLoop(List<int> nums)
    {
        int highestNum = nums[0];
        int i = 1;
        while (i < nums.Count)
